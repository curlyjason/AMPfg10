...
//	foreach ($orders as $order): ?>
	<tr>
		<td><?php echo h(date('m/d/Y', strtotime($order['Order']['created']))); ?>&nbsp;</td>
		<td><?php echo h($order['Order']['order_number']); ?>&nbsp;</td>
		<td><?php echo h($order['Order']['status']); ?>&nbsp;</td>
		<td><?php echo h($order['Order']['billing_company']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $order['Order']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $order['Order']['id'])); ?>
			<?php echo $this->Html->link(__('Ship'), array('action' => 'statusChange', $order['Order']['id'], 'Ship')); ?>
			<?php echo $this->Html->link(__('Invoice'), array('action' => 'statusChange', $order['Order']['id'], 'Invoice')); ?>
