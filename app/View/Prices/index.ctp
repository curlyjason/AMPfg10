<div class="prices index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('max_qty'); ?></th>
			<th><?php echo $this->Paginator->sort('price'); ?></th>
			<th><?php echo $this->Paginator->sort('test_max_qty'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($price['Price']['min_qty']); ?>&nbsp;</td>
		<td><?php echo h($price['Price']['max_qty']); ?>&nbsp;</td>
		<td><?php echo h($price['Price']['price']); ?>&nbsp;</td>
		<td><?php echo h($price['Price']['test_max_qty']); ?>&nbsp;</td>
		<td class="actions">
