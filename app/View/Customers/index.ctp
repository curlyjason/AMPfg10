<div class="customers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('order_contact'); ?></th>
			<th><?php echo $this->Paginator->sort('billing_contact'); ?></th>
			<th><?php echo $this->Paginator->sort('allow_backorder'); ?></th>
			<th><?php echo $this->Paginator->sort('allow_direct_pay'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($customer['Customer']['order_contact']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['billing_contact']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['allow_backorder']); ?>&nbsp;</td>
		<td><?php echo h($customer['Customer']['allow_direct_pay']); ?>&nbsp;</td>
		<td>
