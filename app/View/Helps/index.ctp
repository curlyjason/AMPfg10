<div class="helps index">
	...
	<tr>
		...
		<td><?php echo h($help['Help']['help']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $help['Help']['id']), null, __('Are you sure you want to delete # %s?', $help['Help']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
