<div class="menus index">
	...
	<tr>
			<th><?php echo $this->Paginator->sort('ParentMenu.name', 'Menu'); ?></th>
	...
	<tr>
		<td><?php echo h($menu['ParentMenu']['name']); ?>&nbsp;</td>
		<td><?php echo h($menu['Menu']['name']); ?>&nbsp;</td>
		<td><?php echo h($menu['Menu']['controller']); ?>&nbsp;</td>
		<td><?php echo h($menu['Menu']['action']); ?>&nbsp;</td>
		<td><?php echo h($menu['Menu']['group']); ?>&nbsp;</td>
		<td><?php echo h($menu['Menu']['access']); ?>&nbsp;</td>
		<td class="actions">
