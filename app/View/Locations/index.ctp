<div class="locations index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('building'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($location['Location']['building']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['row']); ?>&nbsp;</td>
		<td><?php echo h($location['Location']['bin']); ?>&nbsp;</td>
		<td class="actions">
