<div class="items index">
	...
	<tr>
		<td><?php echo h($item['Item']['id']);
		echo $this->FgForm->secureId('Item.id', $item['Item']['id']);
?>&nbsp;</td>
		<td><?php echo h($item['Item']['created']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['modified']); ?>&nbsp;</td>
		<td><?php echo h($item['Item']['name']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->FgHtml->securelink(__('View'), $item['Item']['id'], array('action' => 'view')); ?>
			<?php echo $this->FgHtml->securelink(__('Edit'), $item['Item']['id'], array('action' => 'edit')); ?>
