...
<?php echo $this->Form->create('ReplenishmentItem'); ?>
	<fieldset>
		<legend><?php echo __('Edit Replenishment Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ReplenishmentItem.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ReplenishmentItem.id'))); ?></li>
